...
export default function App() {
  // Estado para almacenar las películas que el usuario ha visto (no se usa en este código)
  ...
  function handleAddWatched(movie) {
    ...
    //Utilizamos el localStorage para almacenar las peliculas
    ...
    <>
      ...
      <Main>
        ...
        <Box>
          ...
          {isLoading && <Loader />}
          {/* Si no está cargando y no hay errores, muestra la lista de películas */}
          {!isLoading && !error && (
...
function Search({ query, setQuery }) {
  const inputEl = useRef(null); //Para seleccionar elementos del DOM
